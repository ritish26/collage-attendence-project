    ...
    public void Adddata(){
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean isInsertedto=mydb.insertdata2(t1.getText().toString(),t2.getText().toString(),t3.getText().toString());
                if(isInsertedto==true)
                    Toast.makeText(Eigth.this, "Data inserted", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(Eigth.this, "Data is not inserted", Toast.LENGTH_LONG).show();
