    ...
    public void Adddata(){
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean isInsertedto=mydb.insertdata(t1.getText().toString(),t2.getText().toString(),t3.getText().toString());
                if(isInsertedto==true)
                    Toast.makeText(SixthActivity.this, "Data inserted", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(SixthActivity.this, "Data is not inserted", Toast.LENGTH_LONG).show();
